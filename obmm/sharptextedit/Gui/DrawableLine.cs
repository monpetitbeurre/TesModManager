...
namespace ICSharpCode.TextEditor
{
	...
	public class DrawableLine
	{
		...
		private class SimpleTextWord {
			...
			public readonly static SimpleTextWord Space = new SimpleTextWord(TextWordType.Space, " ", false, Color.Black);
			public readonly static SimpleTextWord Tab = new SimpleTextWord(TextWordType.Tab, "\t", false, Color.Black);
		}
