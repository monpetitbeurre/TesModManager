...
namespace ICSharpCode.SharpZipLib.Zip.Compression 
{
	...
	public class DeflaterHuffman
	{
		...
		public class Tree 
		{
			...
			/// <summary>
			/// Resets the public state of the tree
			/// </summary>
			public void Reset() 
			{
		...
		/// <summary>
		/// Get value indicating if public buffer is full
		/// </summary>
		...
		/// <returns>Value indicating public buffer is full</returns>
		...
		/// <returns>Value indicating if public buffer is full</returns>
