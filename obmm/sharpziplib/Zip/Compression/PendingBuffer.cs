...
namespace ICSharpCode.SharpZipLib.Zip.Compression 
{
	...
	public class PendingBuffer
	{
		...
		/// <summary>
		/// Align public buffer on a byte boundary
		/// </summary>
		...
		/// <summary>
		/// Write a short value to public buffer most significant byte first
		/// </summary>
		/// <param name="s">value to write</param>
		...
		/// <summary>
		/// Convert public buffer to byte array.
