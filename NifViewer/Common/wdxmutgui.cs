...
// File: WDXMUTGui.cs
//
// DirectX SDK Managed Direct3D for Whidbey GUI Sample Code
//
...
namespace Microsoft.Samples.DirectX.UtilityToolkit
{
    ...
    public class Element : ICloneable
    {
        ...
        public DrawStringFormat stringFormat; // The Format argument to draw text
        ...
        public void SetFont(uint font, ColorValue defaultFontColor, DrawStringFormat format)
        {
            // Store data
            FontIndex = font;
            stringFormat = format;
        ...
        /// <summary>Set the font</summary>
        public void SetFont(uint font) { SetFont(font, Dialog.WhiteColorValue, DrawStringFormat.Center | DrawStringFormat.VerticalCenter); }
        /// <summary>
        ...
        public Element Clone()
        {
            ...
            e.stringFormat = this.stringFormat;
    ...
    public sealed class DialogResourceManager
    {
        ...
        public void CreateTexture(int tex)
        {
            ...
            tn.Texture = new Texture(device, path, Constants.Default, Constants.Default, Constants.Default, Usage.None,
                Format.Unknown, Pool.Managed, (Filter)Constants.Default, (Filter)Constants.Default, 0, true, null);

            // Store dimensions
            tn.Width = (uint)tn.Texture.ImageInformation.Width;
            tn.Height = (uint)tn.Texture.ImageInformation.Height;
        ...
        public void OnLostDevice()
        {
            foreach (FontNode fn in fontCache)
            {
                if ((fn.Font != null) && (!fn.Font.IsDisposed))
    ...
    public class Dialog
    {
        ...
        // Vertex information
        private Microsoft.DirectX.Generic.GraphicsBuffer<TransformedColoredTextured> vertices;
        ...
        private void InitializeDefaultElements()
        {
            ...
            captionElement.SetFont(0, WhiteColorValue, DrawStringFormat.Left | DrawStringFormat.VerticalCenter);
            ...
            e.SetFont(0, WhiteColorValue, DrawStringFormat.Left | DrawStringFormat.VerticalCenter);
            ...
            e.SetFont(0, BlackColorValue, DrawStringFormat.Left | DrawStringFormat.Top);
            // Assign the element
            ...
            e.SetFont(0, WhiteColorValue, DrawStringFormat.Left | DrawStringFormat.Top);
            // Assign the element
        ...
        {
            vertices = new Microsoft.DirectX.Generic.GraphicsBuffer<TransformedColoredTextured>(4);
            vertices.Write(new TransformedColoredTextured(dialogX,dialogY,0.5f,1.0f,topLeftColor.ToArgb(),0.0f,0.5f));
            vertices.Write(new TransformedColoredTextured(dialogX + width,dialogY,0.5f,1.0f,topRightColor.ToArgb(),1.0f,0.5f));
            vertices.Write(new TransformedColoredTextured(dialogX+width,dialogY+height,0.5f,1.0f,bottomRightColor.ToArgb(),1.0f,1.0f));
            vertices.Write(new TransformedColoredTextured(dialogX, dialogY + height, 0.5f, 1.0f, bottomLeftColor.ToArgb(), 0.0f, 1.0f));
        }
        ...
        public void OnRender(float elapsedTime)
        {
            ...
            if (hasCaption)
            {
                ...
                DrawString(output, captionElement, rect, true);
            }
        ...
        public void DrawString(string text, Element element, System.Drawing.Rectangle rect, bool shadow)
        {
            ...
            if (shadow)
            {
                ...
                fNode.Font.DrawString(DialogResourceManager.GetGlobalInstance().Sprite, text,
                    shadowRect, element.stringFormat, unchecked((int)0xff000000));
            }

            fNode.Font.DrawString(DialogResourceManager.GetGlobalInstance().Sprite, text,
                screenRect, element.stringFormat, element.FontColor.Current.ToArgb());
        }
        ...
        /// <summary>Draw's some text</summary>
        public void DrawString(string text, Element element, System.Drawing.Rectangle rect) { this.DrawString(text, element, rect, false); }
        ...
        public void DrawRectangle(System.Drawing.Rectangle rect, ColorValue color)
        {
            ...
            Microsoft.DirectX.Generic.GraphicsBuffer<TransformedColoredTextured> verts = new Microsoft.DirectX.Generic.GraphicsBuffer<TransformedColoredTextured>(4);
            verts.Write(new TransformedColoredTextured((float)rect.Left - 0.5f, (float)rect.Top - 0.5f, 0.5f, 1.0f, realColor, 0, 0));
            verts.Write(new TransformedColoredTextured((float)rect.Right - 0.5f, (float)rect.Top -0.5f, 0.5f, 1.0f, realColor, 0, 0));
            verts.Write(new TransformedColoredTextured((float)rect.Right - 0.5f, (float)rect.Bottom -0.5f, 0.5f, 1.0f, realColor, 0, 0));
            verts.Write(new TransformedColoredTextured((float)rect.Left - 0.5f, (float)rect.Bottom -0.5f, 0.5f, 1.0f, realColor, 0, 0));
    ...
    public class StaticText : Control
    {
        ...
        public override void Render(Device device, float elapsedTime)
        {
            ...
            parentDialog.DrawString(textData, e, boundingBox, true);
        }
    ...
    public class Button : StaticText
    {
        ...
        public override void Render(Device device, float elapsedTime)
        {
            ...
            parentDialog.DrawString(textData, e, buttonRect);
    ...
    public class Checkbox : Button
    {
        ...
        public override void Render(Device device, float elapsedTime)
        {
            ...
            parentDialog.DrawSprite(e, buttonRect);
            parentDialog.DrawString(textData, e, textRect);
        ...
        public override void Render(Device device, float elapsedTime)
        {
            ...
            for (int i = scrollbarControl.TrackPosition; i < itemList.Count; i++)
            {
                ...
                if (isComboOpen)
                {
                    if (focusedIndex == i)
                    {
                        ...
                        parentDialog.DrawString(cbi.ItemText, selectionElement, cbi.ItemRect);
                    }
                    else
                    {
                        parentDialog.DrawString(cbi.ItemText, e, cbi.ItemRect);
                    }
                }
            }
            ...
            if (selectedIndex >= 0 && selectedIndex < itemList.Count)
            {
                try
                {
                    ...
                    parentDialog.DrawString(cbi.ItemText, e, textRect);
                }
                catch { } // Ignore
            }
            ...
            if (itemList.Count > 0)
            {
                ...
                for (int i = scrollbarControl.TrackPosition; i < itemList.Count; ++i)
                {
                    ...
                    if (isSelectedStyle)
                    {
                        ...
                        parentDialog.DrawString(lb.ItemText, selectedElement, rc);
                    }
                    else
                        parentDialog.DrawString(lb.ItemText, e, rc);
    ...
    public class EditBox : Control
    {
        ...
        public override void Render(Device device, float elapsedTime)
        {
            ...
            parentDialog.DrawString(textData.Text.Substring(firstVisible), textElement, textRect);
            ...
            if (caretPosition != textData.SelectionStart)
            {
                ...
                parentDialog.DrawString(textData.Text.Substring(firstToRender, numToRender), textElement, selRect);
            }
